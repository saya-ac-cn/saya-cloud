...
<script>
import { totalTransactionForMonth, outTransactionForMonthExcel } from '../../api/api';
export default {
  name: 'FinancialForMonth',
  data()  {
    return  {
      // 返回的单元格数据
      datas: [],
  ...
  methods:  {
    ...
    getData() {
      ...
      //NProgress.start();
      totalTransactionForMonth(para).then((datas) => {
    ...
    downloadExcel() {
      ...
      form.action = outTransactionForMonthExcel ;
      form.submit();
