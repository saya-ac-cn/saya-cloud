  ...
  <section>
    ...
    <el-dialog title="上传壁纸" v-model="addFormVisible" :close-on-click-modal="false" :visible.sync="addFormVisible" :append-to-body="true">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click.native="uploadWallpaper" :loading="addLoading">上传</el-button>
      </div>
    </el-dialog>
...
<script>
import { getPictureList, deletePicture,uploadWallpaper } from '../../api/api';
export default {
  name: 'wallpaper',
  data()  {
    return  {
