...
<script>
import { totalTransactionForDay, outTransactionForDayExcel } from '../../api/api';
export default {
  name: 'FinancialForDay',
  data()  {
    return  {
      filters: {
        // 查询的日期
  ...
  methods:  {
    ...
    getData() {
      ...
      //NProgress.start();
      totalTransactionForDay(para).then((datas) => {
    ...
    downloadExcel() {
      ...
      form.action = outTransactionForDayExcel ;
      form.submit();
